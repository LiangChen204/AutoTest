...
////    private final static String TAG = "com.javabase.util.ReflectClass";
//
//    //创建对象
...
//                Object objectBook = declaredConstructorBook.newInstance("有时候，塞翁失马", "焉知非福");
//                Book book = (Book)objectBook;
...
//            zenMode = mGetZenMode.invoke(oINotificationManager).hashCode();
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
//
